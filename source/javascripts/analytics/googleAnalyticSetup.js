// We are no longer using the Analytics code built into the 
// Tech Docs gem.  We have to manually trigger the analytics 
// depending on if the user has the cookie consent cookie = true.
// Also, the built Tech Docs gem still loads in the Google Analytics
// JS file even if the the user has not selected Analytic cookies.
// This Analytics code has been taken straight from the Tech Docs
// gem.  
