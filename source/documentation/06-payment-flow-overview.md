...
Note that this page might be the end of a series of pages you host which allow the user to choose between a variety of possible payments. This page should:
...
See the [Integration details](/integration_details/#integration-details) section for more details about how to match the user to the payment.
...
Now that you understand the payment process, see the [Integration details](/integration_details/#integration-details) section for more  about how you can integrate your service with GOV.UK Pay.
